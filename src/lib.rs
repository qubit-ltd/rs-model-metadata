...
use pipeline::MacroKind;
use proc_macro::TokenStream;

fn expand(kind: MacroKind, args: TokenStream, input: TokenStream) -> TokenStream {
    pipeline::expand(kind, args.into(), input.into()).into()
}
...
pub fn Entity(args: TokenStream, input: TokenStream) -> TokenStream {
    expand(MacroKind::Entity, args, input)
}
...
pub fn Projection(args: TokenStream, input: TokenStream) -> TokenStream {
    expand(MacroKind::Projection, args, input)
}
...
pub fn Model(args: TokenStream, input: TokenStream) -> TokenStream {
    expand(MacroKind::Model, args, input)
}
...
pub fn Enum(args: TokenStream, input: TokenStream) -> TokenStream {
    expand(MacroKind::Enum, args, input)
}
...
pub fn Value(args: TokenStream, input: TokenStream) -> TokenStream {
    expand(MacroKind::Value, args, input)
}
...
pub fn ModelProperties(args: TokenStream, input: TokenStream) -> TokenStream {
    expand(MacroKind::ModelProperties, args, input)
}
