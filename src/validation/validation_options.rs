...
impl FieldPath {
    ...
    pub fn new(path: impl Into<String>) -> Self {
        Self { segments: path.into().split('.').map(str::to_owned).collect() }
    }
    ...
    pub(crate) fn segments(&self) -> &[String] { &self.segments }
}
...
impl ValidationOptions {
    ...
    #[must_use]
    pub fn with_mode(mut self, mode: ValidationMode) -> Self { self.mode = mode; self }
    /// Selects fields to validate.
    #[must_use]
    pub fn with_selection(mut self, selection: ValidationSelection) -> Self { self.selection = selection; self }
    /// Sets the maximum traversal depth.
    #[must_use]
    pub fn with_max_depth(mut self, value: NonZeroUsize) -> Self { self.max_depth = value; self }
    /// Sets the maximum number of visited nodes.
    #[must_use]
    pub fn with_max_nodes(mut self, value: NonZeroUsize) -> Self { self.max_nodes = value; self }
    /// Sets the maximum number of violations retained.
    #[must_use]
    pub fn with_max_violations(mut self, value: NonZeroUsize) -> Self { self.max_violations = value; self }
    /// Sets the maximum collection comparisons.
    #[must_use]
    pub fn with_max_comparisons(mut self, value: NonZeroUsize) -> Self { self.max_comparisons = value; self }
    pub(crate) const fn mode(&self) -> ValidationMode { self.mode }
    pub(crate) const fn selection(&self) -> &ValidationSelection { &self.selection }
    pub(crate) const fn max_depth(&self) -> usize { self.max_depth.get() }
    pub(crate) const fn max_nodes(&self) -> usize { self.max_nodes.get() }
    pub(crate) const fn max_violations(&self) -> usize { self.max_violations.get() }
    pub(crate) const fn max_comparisons(&self) -> usize { self.max_comparisons.get() }
}
