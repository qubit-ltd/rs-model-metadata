...
| KEY | `REQ-KEY-001`、`REQ-KEY-002`、`REQ-KEY-003`、`REQ-KEY-004`、`REQ-KEY-005`、`REQ-KEY-006` | 自动化 | `tests/role_metadata_runtime_tests.rs`、`tests/ui_roles/{pass/current_public_contract,fail/semantic_boundaries,fail/field_semantics}.rs`、`rs-model-metadata/tests/metadata_resolver_tests.rs` |
