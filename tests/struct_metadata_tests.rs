...
static DECLARED_FIELDS: [FieldMetadata; 1] = [FieldMetadata::new(0, "id", "i64", TypeRef::of::<i64>(), &[])];
static EMPTY_NAME_FIELDS: [FieldMetadata; 1] = [FieldMetadata::new(0, "", "i64", TypeRef::of::<i64>(), &[])];
